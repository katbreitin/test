...
module SIMPLE_COD_065um_MOD
   ...
   public:: COMPUTE_SIMPLE_SOLAR_COD_065um
   ...
   !===========================================================================
   subroutine COMPUTE_SIMPLE_SOLAR_COD_065um(Number_Elements, Number_Lines)
   ...
   end subroutine COMPUTE_SIMPLE_SOLAR_COD_065um
   !===========================================================================
...
end module SIMPLE_COD_065um_MOD
