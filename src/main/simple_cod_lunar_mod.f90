...
module SIMPLE_COD_LUNAR_MOD
   ...
   public:: COMPUTE_SIMPLE_LUNAR_COD_065um
   ...
   !===========================================================================
   subroutine COMPUTE_SIMPLE_LUNAR_COD_065um(Number_Elements, Number_Lines)
   ...
   end subroutine COMPUTE_SIMPLE_LUNAR_COD_065um
...
end module SIMPLE_COD_LUNAR_MOD
