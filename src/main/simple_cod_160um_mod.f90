...
module SIMPLE_COD_160um_MOD
   ...
   public:: COMPUTE_SIMPLE_SOLAR_COD_160um
   ...
   character(len=100):: filename = 'simple_160um_ref_lut_wat_cld.bin'
   ...
   !===========================================================================
   subroutine COMPUTE_SIMPLE_SOLAR_COD_160um(Number_Elements, Number_Lines)
      ...
      Element_Loop: do Elem_Idx = 1, Number_Elements
         Line_Loop: do Line_Idx = 1, Number_Lines
            ...
            Alb_Sfc = ch(ichan)%Sfc_Ref_White_Sky(Elem_Idx,Line_Idx)
            if (Alb_Sfc < 0.0) then
               Alb_Sfc = Ch6_Sfc_Alb_Umd(Sfc%Sfc_Type(Elem_Idx,Line_Idx))
            endif
            !if (Sfc%Snow(Elem_Idx,Line_Idx) /=sym%NO_SNOW) then
            !   Alb_Sfc = Ch6_Snow_Sfc_Alb_Umd(Sfc%Sfc_Type(Elem_Idx,Line_Idx))
            !endif
   ...
   end subroutine COMPUTE_SIMPLE_SOLAR_COD_160um
   !===========================================================================
...
end module SIMPLE_COD_160um_MOD
