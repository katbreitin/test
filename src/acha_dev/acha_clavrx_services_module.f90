...
!ACHA input structure
 ...
 real (kind=real4), dimension(:,:), pointer:: Lower_Tc_Ap
 real (kind=real4), dimension(:,:), pointer:: Tc_Ap_Uncer
 real (kind=real4), dimension(:,:), pointer:: Ec_Ap_Uncer
 real (kind=real4), dimension(:,:), pointer:: Beta_Ap_Uncer
 real (kind=real4), dimension(:,:), pointer:: Ice_Prob_Ap_Uncer
 real (kind=real4), dimension(:,:), pointer:: Lower_Tc_Ap_Uncer
 real (kind=real4), dimension(:,:), pointer:: QRNN_Pc
 real (kind=real4), dimension(:,:), pointer:: QRNN_Pc_Uncer
