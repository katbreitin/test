...
module NB_CLOUD_MASK_LUT_MODULE
 ...
 use NB_CLOUD_MASK_NETCDF_READ_MODULE
...
!====================================================================
 subroutine READ_NAIVE_BAYES_LUT(Naive_Bayes_File_Name_Full_Path, &
   ...
   allocate(Classifier_Value_Name(N_class))
   ...
   var_name="prior_yes"
   call read_netcdf_1d_real(ncid,(/1/),(/1/),(/N_sfc_bayes/),var_name,Prior_Yes)

   var_name="prior_no"
   call read_netcdf_1d_real(ncid,(/1/),(/1/),(/N_sfc_bayes/),var_name,Prior_No)

   var_name="optimal_posterior_prob"
   call read_netcdf_1d_real(ncid,(/1/),(/1/),(/N_sfc_bayes/),var_name,Optimal_Posterior_Prob)
   ...
   var_name="bin_start"
   call read_netcdf_2d_real(ncid, sds_start_2d, (/1,1/), sds_edge_2d, &
   ...
   call read_netcdf_2d_int(ncid, sds_start_2d, (/1,1/), sds_edge_2d, &
   ...
   call read_netcdf_2d_char(ncid, sds_start_2d, var_name, Classifier_Value_Name)
   ...
   call read_netcdf_3d_real(ncid, sds_start_3d, (/1,1,1/), sds_edge_3d, &
...
!============================================================================
  subroutine READ_PRIOR(File_Name)
   ...
   call read_netcdf_4d_real(ncid, (/1,1,1,1/), (/1,1,1,1/), &
                         (/nlon_prior,nlat_prior,nmonths_prior, ndiurnal_prior/), &
...
!====================================================================
 subroutine READ_CORE_LUT_NIGHT(File_Name)
  ...
  call read_netcdf_3d_real(ncid, (/1,1,1/), (/1,1,1/), &
