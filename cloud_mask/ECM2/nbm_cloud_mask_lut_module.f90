...
do Class_Idx = 1, N_Classifier
   ...
   call READ_NETCDF_GLOBAL_ATTRIBUTE_I4(Group_Id, 'rank', Lut(Class_Idx)%Rank, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_I4(Group_Id, 'nchan_used', Lut(Class_Idx)%Nchan_Used, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_I4(Group_Id, 'nsfc', Lut(Class_Idx)%N_Sfc, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_CHAR(Group_Id, 'x_name', Lut(Class_Idx)%Class_Xname, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_I4(Group_Id, 'nbins_x', Lut(Class_Idx)%Nbins_X, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'x_min', Lut(Class_Idx)%X_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'x_bin', Lut(Class_Idx)%X_Bin, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_CHAR(Group_Id, 'y_name', Lut(Class_Idx)%Class_Yname, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_I4(Group_Id, 'nbins_y', Lut(Class_Idx)%Nbins_Y, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'y_min', Lut(Class_Idx)%Y_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'y_bin', Lut(Class_Idx)%Y_Bin, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_CHAR(Group_Id, 'z_name', Lut(Class_Idx)%Class_Zname, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_I4(Group_Id, 'nbins_z', Lut(Class_Idx)%Nbins_Z, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'z_min', Lut(Class_Idx)%Z_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'z_bin', Lut(Class_Idx)%Z_Bin, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'zenith_minimum', Lut(Class_Idx)%Zen_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'zenith_maximum', Lut(Class_Idx)%Zen_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'solar_zenith_minimum', Lut(Class_Idx)%Solzen_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'solar_zenith_maximum', Lut(Class_Idx)%Solzen_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'solar_glint_zenith_minimum', Lut(Class_Idx)%Solglintzen_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'solar_glint_zenith_maximum', Lut(Class_Idx)%Solglintzen_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'solglint_mask_minimum', Lut(Class_Idx)%Solglint_Mask_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'solglint_mask_maximum', Lut(Class_Idx)%Solglint_Mask_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'surface_elevation_minimum', Lut(Class_Idx)%Zsfc_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'surface_elevation_maximum', Lut(Class_Idx)%Zsfc_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'surface_elevation_stddev_minimum', Lut(Class_Idx)%Zsfc_Std_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'surface_elevation_stddev_maximum', Lut(Class_Idx)%Zsfc_Std_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'surface_temperature_minimum', Lut(Class_Idx)%Tsfc_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'surface_temperature_maximum', Lut(Class_Idx)%Tsfc_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'total_precipitable_water_minimum', Lut(Class_Idx)%Tpw_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'total_precipitable_water_maximum', Lut(Class_Idx)%Tpw_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'snow_class_minimum', Lut(Class_Idx)%Snow_Class_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'snow_class_maximum', Lut(Class_Idx)%Snow_Class_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'lunar_zenith_minimum', Lut(Class_Idx)%Lunzen_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'lunar_zenith_maximum', Lut(Class_Idx)%Lunzen_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'lunar_glint_zenith_minimum', Lut(Class_Idx)%Lunglintzen_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'lunar_glint_zenith_maximum', Lut(Class_Idx)%Lunglintzen_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'lunglint_mask_minimum', Lut(Class_Idx)%Lunglint_Mask_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'lunglint_mask_maximum', Lut(Class_Idx)%Lunglint_Mask_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'solar_scattering_angle_minimum', Lut(Class_Idx)%Solscatang_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'solar_scattering_angle_maximum', Lut(Class_Idx)%Solscatang_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'coast_mask_minimum', Lut(Class_Idx)%Coast_Mask_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'coast_mask_maximum', Lut(Class_Idx)%Coast_Mask_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'city_mask_minimum', Lut(Class_Idx)%City_Mask_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'city_mask_maximum', Lut(Class_Idx)%City_Mask_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'moon_illum_frac_minimum', Lut(Class_Idx)%Moon_Illum_Frac_Min, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'moon_illum_frac_maximum', Lut(Class_Idx)%Moon_Illum_Frac_Max, Class_Idx)
   call READ_NETCDF_GLOBAL_ATTRIBUTE_R4(Group_Id, 'rut_solzen_thresh', Lut(Class_Idx)%Rut_Solzen_Thresh, Class_Idx) 
