!$Id: ir_cloud_type_baum_module.f90 3189 2019-03-11 22:04:07Z heidinger $
...
! UNKNOWN_PHASE = 5
!====================================================================
  use CONSTANTS_MOD, only: real4, sym, Cloud_Type_IR_Version
  use PIXEL_COMMON_MOD, only: Image,  &
                          Ch,     &
                          Geo,    &
                          Sensor, &
                          Sfc,    &
...
subroutine SET_IR_CLOUD_TYPE_VERSION()
   Cloud_Type_IR_Version = "$Id: ir_cloud_type_baum_module.f90 3189 2019-03-11 22:04:07Z heidinger $"
