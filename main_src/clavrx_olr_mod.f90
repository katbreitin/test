! $Id: clavrx_olr_mod.f90 4034 2020-10-16 17:36:01Z heidinger $
!--------------------------------------------------------------------------------------
...
!
!--------------------------------------------------------------------------------------
module CLAVRX_OLR_MOD
use CONSTANTS_MOD
use PIXEL_COMMON_MOD, only: ch, sensor, geo, olr
...
select case (Sensor%WMO_Id)
      ...
      case(55) !MSG-1
         olr_type = 'goes'
         olr_coef(1:5) = (/11.6937, 0.582146, 0.345428, 0.00994980, 0.00960586/)

      case(56) !MSG-2
         olr_type = 'goes'
         olr_coef(1:5) = (/11.6695, 0.582438, 0.345315, 0.00993986, 0.00955230/)

      case(57) !MSG-3
         olr_type = 'goes'
         olr_coef(1:5) = (/11.7873,0.582069,0.345052,0.00996490, 0.00965233/)

      case(70) !MSG-4
         olr_type = 'goes'
         olr_coef(1:5) = (/11.6053,0.581711,0.346211,0.00996377,0.00962677/)
      ...
      case(173) !AHI-8
         olr_type = 'goes'
         olr_coef(1:5) = (/18.1838,0.554070,0.339000,0.00936060,0.00649715/)
      ...
      case(224,225) !NPP-VIIRS, NOAA-20 VIIRS
         olr_type = 'avhrr'
      ...
      case(270) !GOES-16
         olr_type = 'goes'
         olr_coef(1:5) = (/17.8647,0.553889,0.340708,0.00938698,0.00656284/)
      ...
      case(530) !FY-4A
         olr_type = 'goes'
         olr_coef(1:5) = (/11.4498,0.577151,0.350992,0.00994385,0.00983503/)
